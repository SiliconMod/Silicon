    ...
    private void rebuild() {
        ...
        cont.table(analog -> {
            ...
            analog.table(vp -> {
                ...
                vp.margin(6f);
                vp.defaults().pad(2f);
                vp.image(Icon.chat).size(Scl.scl(14f)).padRight(2f);
            ...
            analog.table(sp -> {
                ...
                sp.margin(6f);
                sp.defaults().pad(2f);
                sp.image(Icon.rightSmall).size(Scl.scl(14f)).padRight(2f);
        ...
        cont.table(abRow -> {
            ...
            abRow.image(Icon.book).size(Scl.scl(14f)).padRight(2f);
